...
const Registration = () => {
	...
	const rightRegistration1 = () => (
		<>
			...
			<Button size="medium" className="mr-8" state="primary" onClick={handleRegistration1}>
				Tiếp tục
			</Button>
		</>
	);
	const rightRegistration2 = () => (
		<>
			...
			<div className="flex mb-6 align-center">
				...
				<div>
					<p className="headline bold pb-6 mt-6">Chọn ảnh đại diện cho salon của bạn</p>
			...
			<Input
				...
				size="medium"
			/>
			<Input className="mb-6" label="Địa điểm salon" placeholder="Salon của bạn ở đâu ?" size="medium" />

			<Button size="medium" className="mr-8" state="primary" onClick={() => setStepper(3)}>
				Tiếp tục
			</Button>
		</>
	);
	const rightRegistration3 = () => (
		<>
			...
			<Input className="mb-6" label="Khác" placeholder="Nhập  nhu cầu khác của bạn." size="medium" />

			<Button size="medium" className="mr-8" state="primary" onClick={() => setStepper(4)}>
				Tiếp tục
			</Button>
		</>
	);
	const rightRegistration4 = () => (
		<>
			...
			<Button size="medium" className="mr-8" state="primary" onClick={() => navigate('/')}>
				Đến trang quản lý
			</Button>
		</>
	);
